...
class ConnectionController extends AbstractController
{
    ...
    //#[Route('/connection', name: 'levelup_comptes_connection', methods: ['GET'])]
    ...
    // #[Route('/comptes/connection', name: 'levelup_comptes_create', methods: ['GET', 'POST'])]
    ...
    //         //$utilisateur->setIsPublished(false);
    //         $entityManager->persist($utilisateur);
    //         $entityManager->flush();

    //         return $this->redirectToRoute('levelup_home_page');
    //     }
